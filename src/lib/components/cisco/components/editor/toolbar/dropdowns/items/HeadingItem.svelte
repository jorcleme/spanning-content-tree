...
>
	{#if headingSize.charAt(1) === '1'}
		<Heading1 class="w-4 h-4 text-gray-500 mr-2" />
	{:else if headingSize.charAt(1) === '2'}
		<Heading2 class="w-4 h-4 text-gray-500 mr-2" />
	{:else if headingSize.charAt(1) === '3'}
		<Heading3 class="w-4 h-4 text-gray-500 mr-2" />
	{:else if headingSize.charAt(1) === '4'}
		<Heading4 class="w-4 h-4 text-gray-500 mr-2" />
	{:else if headingSize.charAt(1) === '5'}
		<Heading5 class="w-4 h-4 text-gray-500 mr-2" />
	{:else if headingSize.charAt(1) === '6'}
		<Heading6 class="w-4 h-4 text-gray-500 mr-2" />
	{/if}
