"""Peewee migrations -- 020_add_published_and_user_id_to_articles.py.
...
def migrate(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.add_fields(
        "articles",
        published=pw.BooleanField(null=True),
...
def rollback(migrator: Migrator, database: pw.Database, *, fake=False):
    ...
    migrator.remove_fields("articles", "published", "user_id", "sources")
